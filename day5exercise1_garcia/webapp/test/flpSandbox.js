		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#day5exercise1garcia-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercise1garcia-display": {
								"semanticObject": "day5exercise1garcia",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercise1garcia",
									"url": sap.ui.require.toUrl("day5exercise1garcia")
								}
							}
						}
					}
